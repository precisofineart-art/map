...
function zoomToMarker(item) {
  ...
  // after zoom, adjust based on popup size
  setTimeout(() => {
    ...
    // move marker lower so popup fits above
...
function createPopup(item) {
  return new mapboxgl.Popup({
    closeButton: false,
    closeOnClick: false,
    offset: [50, 0],   // 🔥 horizontal shift
    anchor: "left"     // popup appears to right of marker
  }).setHTML(`
    <div class="popup-card">

      <div class="popup-image">
        <img src="${item.image || 'https://picsum.photos/400'}">
      </div>
